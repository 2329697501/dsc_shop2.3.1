<?php exit;?>001479712054ca4a8dba72812d460e4209c773f8196bs:23850:"a:2:{s:8:"template";s:23785:"<?php $__Template->display($this->getTpl("page_header")); ?>
    ...
    <div class="goods-evaluation-page of-hidden ect-tab j-ect-tab">
        <div class="hd j-tab-title tab-title b-color-f of-hidden" style="position:static">
            <ul class="dis-box">
                <li class="box-flex <?php if(!$img) { ?>active<?php } ?>" rank="">全部评价<em class="dis-block m-top04"><?php echo $info['all_comment']; ?></em></li>
                <li class="box-flex" rank="4">好评<em class="dis-block m-top04"><?php echo $info['good_comment']; ?></em></li>
                <li class="box-flex" rank="2">中评<em class="dis-block m-top04"><?php echo $info['in_comment']; ?></em></li>
                <li class="box-flex" rank="1">差评<em class="dis-block m-top04"><?php echo $info['rotten_comment']; ?></em></li>
                <li class="box-flex <?php if($img) { ?>active<?php } ?>" rank="img">有图<em class="dis-block m-top04"><?php echo $info['img_comment']; ?></em></li>
            </ul>
        </div>
...
<input type="hidden" name="goods" value="<?php echo $id; ?>">
<script>
    /*!
...
<script>
    ...
    var url = "<?php echo U('goods/index/comment');?>";
...
</html>";s:12:"compile_time";i:1479625654;}";