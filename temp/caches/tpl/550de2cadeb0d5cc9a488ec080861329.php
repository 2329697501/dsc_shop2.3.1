<?php exit;?>0014775339062b0f2f4ae4231754e14ad11e28d32304s:5127:"a:2:{s:8:"template";s:5063:"<?php $__Template->display($this->getTpl("admin/header")); ?>
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div class="flexilist">
            <div class="main-info">
                <form action="<?php echo U('install');?>" method="post" class="form-horizontal" role="form">
                    <div class="switch_info">
                        <?php $n=1; if(is_array($info['config'])) foreach($info['config'] as $key => $vo) { ?>
                        <div class="item">
                            <div class="label-t"><?php echo $vo['label']; ?>：</div>
                            <div class="label_value">
                                <input type="text" name="cfg_value[]" maxlength="50" class="text"
                                       value="<?php echo $vo['value']; ?>"/>
                            ...
                            <div class="label_value">
                                <div class="checkbox_items">
                                    <div class="checkbox_item">
                                        ...
                                        <label for="status_0" class="ui-radio-label active">启用</label>
                                    </div>
                                    <div class="checkbox_item">
                        ...
                        <div class="item">
                            ...
                            <div class="label_value"><a href="<?php echo $info['website']; ?>" class="btn button" target="_blank">立即申请</a>
                            </div>
                        </div>
                        <div class="item">
...
<?php $__Template->display($this->getTpl("admin/footer")); ?>";s:12:"compile_time";i:1477447506;}";