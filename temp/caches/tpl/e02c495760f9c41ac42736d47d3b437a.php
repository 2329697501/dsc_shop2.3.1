<?php exit;?>00147980353719bf5c035f56db6d357abc9d6c961c5cs:6812:"a:2:{s:8:"template";s:6748:"<?php $__Template->display($this->getTpl("page_header")); ?>
				...
				<div class="s-user-top">
					...
					<div class="dis-box s-xian-box s-user-top-1">
						...
						<div class="user-head-img-box-1"><img src="<?php echo $info['user_picture']; ?>"></div>
                                             <?php } else { ?>   
                                             <div class="user-head-img-box-1"><img src="<?php echo __TPL__;?>img/no_image.jpg"></div>
                                            <?php } ?>
...
</html>";s:12:"compile_time";i:1479717137;}";