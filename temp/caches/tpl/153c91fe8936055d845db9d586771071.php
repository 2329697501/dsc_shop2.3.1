<?php exit;?>0014768895577e9086a4f8b6ac81cc4899c31cfe8ce3s:11880:"a:2:{s:8:"template";s:11815:"<?php $__Template->display($this->getTpl("page_header-nav")); ?>
<div class="my-admin-header-box">
				...
				<div class="padding-all dis-box">
					<a href="<?php echo U('profile/index');?>">
						...
						<div class="user-head-img-box"><img src="<?php echo $info['user_picture']; ?>"></div>
                                             <?php } else { ?>
                                             <div class="user-head-img-box"><img src="<?php echo __TPL__;?>img/no_image.png"></div>
                                            <?php } ?>
					</a>
		...
		<section class="b-color-f goods-attr j-goods-attr my-nav-box m-top10">
			...
			<ul class="user-money-list g-s-i-title-2 dis-box text-center my-dingdan">
				...
				<!--<a href="<?php echo __TPL__;?>user_return_list.html" class="box-flex">
					<li>
...
";s:12:"compile_time";i:1476803157;}";