<?php exit;?>0014797403279785663127da344596bcf58e2c007f62s:4113:"a:2:{s:8:"template";s:4049:"<section class="flow-checkout-tprice">
    ...
    <ul class="m-top1px b-color-f">
        ...
        <?php } ?>
          <!-- 优惠券 -->
        <?php if($total['coupons'] > 0 && $order['cou_id'] > 0) { ?>
        <li class="padding-all of-hidden">
