<?php exit;?>00147729788038a161ee20349152a82bbadca3408662s:4212:"a:2:{s:8:"template";s:4148:"<div class="search-div j-search-div ts-3">
    <section class="search">
        ...
        <div class="text-all dis-box j-text-all text-all-back">
            ...
            <div class="box-flex input-text">
                ...
                <input class="j-input-text" type="text" name="keyword" placeholder="<?php if($keywords) { ?><?php echo $keywords; ?><?php } else { ?>商品/店铺搜索<?php } ?>" />
...
</script>";s:12:"compile_time";i:1477211480;}";