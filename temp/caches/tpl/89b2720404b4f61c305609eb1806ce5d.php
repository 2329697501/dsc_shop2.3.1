<?php exit;?>001477297880135fe1185c117f72826d362c08442984s:15977:"a:2:{s:8:"template";s:15912:"<?php $__Template->display($this->getTpl("page_header-nav")); ?>
<body>
<div class="con mb-7">
    <?php if($app) { ?>
    <div class="ect-header-banner dis-box">
        ...
        <div class="box-flex">
            <img src="<?php echo __TPL__;?>img/more_icon.png" class="fl" />
            ...
            <div class="swiper-container recom-container">
                <div class="swiper-wrapper">
                    <ul class="swiper-slide recom-list">
                        <!-- <?php $n=1; if(is_array($promotion_goods)) foreach($promotion_goods as $key => $best) { ?> -->
                        <li>
                            <a href="<?php echo U('goods/index/index', array('id'=>$best['goods_id']));?>">
                                <img src="<?php echo $best['goods_thumb']; ?>" />
                                <p class="index-price text-c"><?php echo $best['current_price']; ?><br><del><?php echo $best['shop_price']; ?></del></p>
                            </a>
                        </li>
                        <!-- <?php if(($key+1)%3 == 0 && $key !== (count($best_goods)-1)) { ?> -->
            ...
            <ul>
              ...
              <li>
                <div class="product-div">
                  <a class="product-div-link" href="<?php echo U('goods/index/index', array('id'=>$best['goods_id']));?>"></a>
        ...
        <div class="swiper-container brand-container b-color-f">
            <div class="swiper-wrapper">
                <ul class="brand-list swiper-slide">
                    ...
                    <li>
                        <a href="<?php echo U('store/index/shopinfo', array('id'=>$val['user_id']));?>">
                            <div class="brand-img">
...
";s:12:"compile_time";i:1477211480;}";