<?php exit;?>00147974032710e09809dad78b08ad58a657c001147bs:48892:"a:2:{s:8:"template";s:48827:"<?php $__Template->display($this->getTpl("page_header")); ?>
        ...
        <div class="flow-checkout">
            ...
            <section class="m-top10">
                <ul>
                    ...
                    <?php } ?>
                   <?php if($allow_use_bonus && $user_bonus_count > 0) { ?>
                    <li class="dis-box padding-all m-top1px b-color-f f-c-s-coupon j-f-c-s-coupon">
                                           <label class="t-remark g-t-temark">红包(<?php echo $user_bonus_count; ?>张)</label>
                        <div class="box-flex t-goods1 text-right onelist-hidden">
                            <?php if($order_bonus) { ?>
                        ...
                        <div id="j-filter-div" class="j-filter-div filter-div ts-5 filter-coupon-div flow-coupon">
                            <div class="con-filter-div" style="height: 90%;">
                                <ul class="select-three flow-couon-list padding-all bonus-list">
                                        ...
                                        <div class="dis-box">
                                            ...
                                            <div class="box-flex b-color-f padding-all">
                                                ...
                                                <div class="ect-select">
                                                    <label data-bonus="<%bonus.bonus_id%>" data-money="<%bonus.type_money%>" <%if <?php echo $order['bonus_id']; ?> == bonus.bonus_id%>class="active" <%/if%> >
                            ...
                            <div class="ect-button-more dis-box n-ect-btn j-coupon-submit flow-coupon">
           ...
           <!--<?php if($user_coupons > 0) { ?>
                        ...
                        <div id="j-filter-div" class="j-filter-div filter-div-1 ts-5 filter-coupon-div-1 flow-coupon">
                            <div class=" con-filter-div-1" style="height: 90%;">
                                <ul class="select-three flow-couon-list padding-all couon-list">
                                    <script id="j-couon-list" type="text/html">
                                    <%each user_coupons as vo%>
                                    <li class="big-remark-all">
                                        <div class="dis-box">
                                            <div class="remark-all temark-1 tb-lr-center">
                                                <span class="b-r-a-price"><sup>¥</sup> <%vo.cou_money%></span>
                                            </div>
                                            <div class="box-flex b-color-f padding-all">
                                               <p><%vo.cou_name%></p>
                                               <p>满<%vo.cou_man%>减<%vo.cou_money%>元</p>
                                                <div class="ect-select">
                                                    <label data-coupont="<%vo.uc_id%>" data-money="<%vo.cou_money%>" <%if <?php echo $order['cou_id']; ?> == vo.uc_id%>class="active"<%/if%> >
                                                           <i class="j-select-btn"></i>
                                                    </label>
                                                </div>
                                            </div>
                            ...
                            <div class="ect-button-more dis-box padding-all">
                                <button class="btn-submit box-flex cou-btn-submit" name="coupont">确定</button>
                            </div>
                        </div>
                        <input type="hidden" name="uc_id" value="<?php echo $order['cou_id']; ?>" id="ECS_COUPONT" />
                    </li>
           <?php } ?>-->
                </ul>
            </section>
...
<script type="text/javascript">
    ...
    <?php if($allow_use_bonus && $user_bonus_count > 0) { ?>
        //  订单确认页面--显示红包
        var url = 'index.php?r=flow/index/get_user_bonus&total_goods_price=<?php echo $total_goods_price; ?>&cart_value=<?php echo $cart_value; ?>';
        $('.bonus-list').infinite({url: url, template:'j-bonus-list'});
    <?php } ?>

    <?php if($user_coupons > 0) { ?>
        //  订单确认页面--显示优惠券
        url = 'index.php?r=flow/index/get_user_couon&total_goods_price=<?php echo $total_goods_price; ?>&cart_value=<?php echo $cart_value; ?>';
...
";s:12:"compile_time";i:1479653927;}";