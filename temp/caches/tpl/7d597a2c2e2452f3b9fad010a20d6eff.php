<?php exit;?>001479710768843978003d0d37eabf45f70d751f3d7as:5432:"a:2:{s:8:"template";s:5368:"<?php $__Template->display($this->getTpl("page_header")); ?>
<div class="con"> 	
...
<script type="text/javascript">
	...
	//订单列表
	var infinite1 = $('.order_info').infinite({url: "<?php echo U('user/refound/index');?>", template: 'j-order', params: 'type=0&order_id='+<?php echo $order_id; ?>});
	var infinite2 = $('.refound_info').infinite({url: "<?php echo U('user/refound/index');?>", template: 'j-refound', params: 'type=1&order_id='+<?php echo $order_id; ?>});
</script>
</body>
</html>
";s:12:"compile_time";i:1479624368;}";