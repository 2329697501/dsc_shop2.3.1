...
$_LANG['prev_step'] = '上一步：';
$_LANG['next_step'] = '下一步：';
$_LANG['copyright'] = '&copy; 2005-2016 <a href="http://www.ecmoban.com" target="_blank">中国百年老店电子商务有限公司（技术支持：领城）</a>。保留所有权利。';
$_LANG['welcome_title'] = '欢迎您选用大商创1.0网上商店管理系统！';
...
$_LANG['checking_title'] = '大商创1.0安装程序 第2步/共3步 环境检测';
...
$_LANG['setup'] = '填写完毕';
$_LANG['setting_title'] = '大商创1.0安装程序 第3步/共3步 配置系统';
...
$_LANG['has_locked_installer'] = '<a style="text-decoration:none; font-size:14px;">安装程序已经被锁定。</a><br /><a style="text-decoration:none; font-size:14px;">如果您确定要重新安装 <font style="color:#ec5150;">大商创1.0</font>，请删除data目录下的 <font style="color:#ec5150;">install.lock.php</font>。</a>';
...
$_LANG['install_done_title'] = '大商创1.0 安装程序 安装成功';
$_LANG['install_error_title'] = '大商创1.0 安装程序 安装失败';
$_LANG['done'] = '基于安全的考虑，请在安装完成后删除 <em>install</em> 目录。';
$_LANG['go_to_view_my_sc'] = '前往 大商创1.0 首页';
$_LANG['go_to_view_control_panel'] = '前往 大商创1.0 后台管理中心';
