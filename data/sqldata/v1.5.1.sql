...
-- http://localhost
-- 
-- DATE : 2016-07-12 18:38:21
-- MYSQL SERVER VERSION : 5.5.40
-- PHP VERSION : 5.3.29
-- ECShop VERSION : v1.5.1
-- Vol : 1
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('101', '1', 'shop_name', 'text', '', '', '大商�\�1.4版本', '1');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('104', '1', 'shop_keywords', 'text', '', '', '大商�\� 免费商城系统 免费B2B2C 免费多商户系�\�  多店铺商城系�\� 企业级电商系�\�  ecshop模板�\�', '1');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('419', '4', 'anonymous_buy', 'select', '1,0', '', '1', '1');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('605', '6', 'install_date', 'hidden', '', '', '1468319736', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('606', '6', 'dsc_version', 'hidden', '', '', 'v1.5', '1');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('918', '8', 'sms_ecmoban_user', 'text', '', '', '', '5');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('919', '8', 'sms_ecmoban_password', 'password', '', '', 'd41d8cd98f00b204e9800998ecf8427e', '4');
