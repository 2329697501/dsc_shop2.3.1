...
-- http://www.100nld.com
-- 
-- DATE : 2016-12-02 11:08:37
-- MYSQL SERVER VERSION : 5.6.28
-- PHP VERSION : 5.3.27
-- ECShop VERSION : v1.9.1
-- Vol : 1
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('102', '1', 'shop_title', 'text', '', '', '百年老店商城—诚信、品质、文化（中国百年老店电商品牌）', '1');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('115', '1', 'service_phone', 'text', '', '', '', '1');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('425', '4', 'send_service_email', 'select', '1,0', '', '1', '1');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('606', '6', 'dsc_version', 'hidden', '', '', 'v1.9', '1');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('616', '6', 'affiliate', 'hidden', '', '', 'a:3:{s:6:\"config\";a:7:{s:6:\"expire\";d:24;s:11:\"expire_unit\";s:4:\"hour\";s:11:\"separate_by\";i:0;s:15:\"level_point_all\";s:2:\"1%\";s:15:\"level_money_all\";s:2:\"1%\";s:18:\"level_register_all\";i:100;s:17:\"level_register_up\";i:600;}s:4:\"item\";a:2:{i:0;a:2:{s:11:\"level_point\";s:3:\"60%\";s:11:\"level_money\";s:3:\"60%\";}i:1;a:2:{s:11:\"level_point\";s:3:\"40%\";s:11:\"level_money\";s:3:\"40%\";}}s:2:\"on\";i:1;}', '1');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('617', '6', 'captcha', 'hidden', '', '', '4', '1');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('918', '8', 'sms_ecmoban_user', 'text', '', '', 'andyrower2016', '4');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('919', '8', 'sms_ecmoban_password', 'password', '', '', '308b4859d0f7661973a5200b936ff511', '5');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('924', '1', 'sign', 'text', '', '', '10', '50');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('940', '3', 'two_code_links', 'text', '', '', 'http://www.100nld.com/', '1');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('951', '942', 'site_domain', 'text', '', '', 'http://www.100nld.com/', '1');
