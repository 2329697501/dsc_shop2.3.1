...
-- http://www.century-oldshop.com
-- 
-- DATE : 2017-08-24 16:02:23
-- MYSQL SERVER VERSION : 5.6.28
-- PHP VERSION : 5.6.31
-- ECShop VERSION : v2.1.2
-- Vol : 1
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('101', '1', 'shop_name', 'text', '', '', '百年老店商城', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('102', '1', 'shop_title', 'text', '', '', '百年老店商城—诚信、品质、文化（中国百年老店电商品牌网上商城）', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('103', '1', 'shop_desc', 'text', '', '', '中国百年老店电子商务有限公司倾力打造百年老店商城，致力于为百年老店企业开辟新的产品营销和文化传播渠道，肩负起振兴民族企业，弘扬传统文化的神圣使命。', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('104', '1', 'shop_keywords', 'text', '', '', '百年老店,百年老店商城', '1');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('106', '1', 'shop_province', 'manual', '', '', '26', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('107', '1', 'shop_city', 'manual', '', '', '322', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('108', '1', 'shop_address', 'text', '', '', '天府二街南华路1616号', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('109', '1', 'qq', 'textarea', '', '', '客服|2313484883', '1');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('114', '1', 'service_email', 'text', '', '', '2313484883@qq.com', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('115', '1', 'service_phone', 'text', '', '', '028-85359239', '1');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('121', '1', 'shop_notice', 'textarea', '', '', '', '1');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('965', '9', 'use_lbs', 'select', '1,0', '', '1', '1');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('202', '2', 'icp_number', 'text', '', '', '蜀ICP备10029450号-2', '1');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('208', '2', 'market_price_rate', 'text', '', '', '1', '1');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('210', '2', 'integral_name', 'text', '', '', '抵用券', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('211', '2', 'integral_scale', 'text', '', '', '100', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('212', '2', 'integral_percent', 'text', '', '', '1', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('213', '2', 'sn_prefix', 'text', '', '', 'BNLD', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('214', '2', 'comment_check', 'select', '0,1', '', '1', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('215', '2', 'no_picture', 'file', '', '../images/', '../images/errorIm.png', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('218', '2', 'stats_code', 'textarea', '', '', '<script>\r\nvar _hmt = _hmt || [];\r\n(function() {\r\n  var hm = document.createElement(\"script\");\r\n  hm.src = \"https://hm.baidu.com/hm.js?ff54202ae40d060e3c5e234b2f52da02\";\r\n  var s = document.getElementsByTagName(\"script\")[0]; \r\n  s.parentNode.insertBefore(hm, s);\r\n})();\r\n</script>', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('219', '2', 'cache_time', 'text', '', '', '360', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('220', '2', 'register_points', 'text', '', '', '500', '1');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('227', '2', 'comment_factor', 'select', '0,1,2,3', '', '3', '1');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('315', '3', 'bought_goods', 'text', '', '', '8', '1');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('319', '3', 'page_size', 'text', '', '', '24', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('320', '3', 'sort_order_type', 'select', '0,1,2', '', '2', '1');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('327', '3', 'name_of_region_2', 'text', '', '', '省', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('328', '3', 'name_of_region_3', 'text', '', '', '市', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('329', '3', 'name_of_region_4', 'text', '', '', '区', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('330', '3', 'search_keywords', 'text', '', '', '百年老店酒,卡斯特,冰箱,手机,苏泊尔', '0');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('401', '4', 'can_invoice', 'select', '1,0', '', '0', '1');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('405', '4', 'use_how_oos', 'select', '1,0', '', '0', '1');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('501', '5', 'smtp_host', 'text', '', '', 'smtp.163.com', '1');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('503', '5', 'smtp_user', 'text', '', '', 'zgbnld@163.com', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('504', '5', 'smtp_pass', 'password', '', '', 'weitang880', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('505', '5', 'smtp_mail', 'text', '', '', 'zgbnld@163.com', '1');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('605', '6', 'install_date', 'hidden', '', '', '1476794493', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('606', '6', 'dsc_version', 'hidden', '', '', 'v2.1.1', '1');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('616', '6', 'affiliate', 'hidden', '', '', 'a:3:{s:6:\"config\";a:11:{s:6:\"expire\";d:24;s:11:\"expire_unit\";s:4:\"hour\";s:11:\"separate_by\";i:0;s:15:\"level_point_all\";s:2:\"1%\";s:15:\"level_money_all\";s:2:\"1%\";s:18:\"level_register_all\";i:0;s:17:\"level_register_up\";i:600;s:26:\"agent_vip_province_general\";s:4:\"0.2%\";s:22:\"agent_vip_city_general\";s:4:\"0.3%\";s:26:\"agent_vip_district_general\";s:4:\"0.5%\";s:21:\"recommend_buy_general\";s:4:\"0.5%\";}s:4:\"item\";a:0:{}s:2:\"on\";i:1;}', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('964', '942', 'add_shop_price', 'select', '0,1', '', '1', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('617', '6', 'captcha', 'hidden', '', '', '20', '1');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('703', '7', 'show_goodsweight', 'select', '1,0', '', '0', '1');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('801', '8', 'sms_shop_mobile', 'text', '', '', '18010633048', '6');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('903', '2', 'message_check', 'select', '1,0', '', '0', '1');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('916', '2', 'customer_service', 'select', '0,1', '', '0', '1');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('918', '8', 'sms_ecmoban_user', 'text', '', '', 'C86270533', '4');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('919', '8', 'sms_ecmoban_password', 'password', '', '', '5f00222b7a7791a710a10d0099e43c19', '5');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('924', '1', 'sign', 'text', '', '', '7', '50');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('934', '2', 'show_warehouse', 'select', '0,1', '', '1', '1');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('937', '9', 'wap_index_pro', 'select', '1,0', '', '0', '1');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('940', '3', 'two_code_links', 'text', '', '', 'http://www.century-oldshop.com/', '1');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('951', '942', 'site_domain', 'text', '', '', 'http://www.century-oldshop.com/', '1');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('954', '942', 'apply_options', 'options', '1,2', '', '2', '3');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('957', '942', 'user_phone', 'select', '0,1', '', '1', '1');
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('960', '8', 'sms_find_signin', 'select', '1,0', '', '1', '15');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('961', '8', 'sms_code', 'select', '1,0', '', '1', '16');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('962', '9', 'migrate_version', 'hidden', '', '', '14815249620', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('966', '942', 'use_coupons', 'select', '0,1', '', '1', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('967', '942', 'tengxun_key', 'text', '', '', '', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('968', '942', 'kuaidi100_key', 'text', '', '', '', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('969', '942', 'ip_type', 'select', '0,1,2', '', '0', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('970', '942', 'ectouch_qrcode', 'file', '', 'images/common/', '../themes/ecmoban_dsc/images/ECtouch_code.png', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('971', '942', 'ecjia_qrcode', 'file', '', 'images/common/', '../themes/ecmoban_dsc/images/ECJia_code.png', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('972', '942', 'index_down_logo', 'file', '', 'images/common/', '../themes/ecmoban_dsc/images/logo_2015_2.png', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('973', '942', 'site_commitment', 'file', '', 'images/common/', 'images/common/site_commitment.jpg', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('974', '942', 'user_login_logo', 'file', '', 'images/common/', '', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('975', '4', 'use_value_card', 'select', '0,1', '', '1', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('976', '942', 'commission_model', 'select', '0,1', '', '0', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('977', '0', 'e_voucher_scale', 'text', '', '', '100', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('978', '2', 'gold_coin_scale', 'text', '', '', '100', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('979', '4', 'use_e_voucher', 'select', '1,0', '', '1', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('980', '4', 'use_gold_coin', 'select', '1,0', '', '1', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('981', '6', 'distribution', 'hidden', '', '', 'a:3:{s:6:\"config\";a:10:{s:5:\"valve\";i:700;s:10:\"valve_unit\";s:4:\"yuan\";s:15:\"gold_coin_valve\";d:700;s:12:\"vip_six_tier\";s:2:\"1%\";s:18:\"value_vip_all_tier\";s:2:\"8%\";s:18:\"agent_vip_province\";s:2:\"1%\";s:14:\"agent_vip_city\";s:2:\"1%\";s:18:\"agent_vip_district\";s:2:\"2%\";s:20:\"resources_can_tixian\";s:3:\"70%\";s:23:\"resources_cannot_tixian\";s:3:\"30%\";}s:5:\"rules\";a:3:{s:2:\"up\";a:3:{i:0;a:4:{s:11:\"first_point\";s:2:\"2%\";s:11:\"first_money\";s:2:\"2%\";s:14:\"no_first_point\";s:2:\"1%\";s:14:\"no_first_money\";s:2:\"2%\";}i:1;a:4:{s:11:\"first_point\";s:2:\"1%\";s:11:\"first_money\";s:2:\"3%\";s:14:\"no_first_point\";s:2:\"1%\";s:14:\"no_first_money\";d:0;}i:2;a:4:{s:11:\"first_point\";s:2:\"1%\";s:11:\"first_money\";s:2:\"5%\";s:14:\"no_first_point\";s:2:\"1%\";s:14:\"no_first_money\";d:0;}}s:3:\"low\";a:1:{i:0;a:4:{s:11:\"first_point\";s:2:\"1%\";s:11:\"first_money\";d:0;s:14:\"no_first_point\";s:2:\"2%\";s:14:\"no_first_money\";s:2:\"3%\";}}s:4:\"self\";a:1:{i:0;a:4:{s:11:\"first_point\";d:0;s:11:\"first_money\";d:0;s:14:\"no_first_point\";s:2:\"1%\";s:14:\"no_first_money\";s:2:\"5%\";}}}s:2:\"on\";i:1;}', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('982', '6', 'recommend_supply_genneral', 'hidden', '', '', 'a:4:{i:0;a:3:{s:4:\"name\";s:6:\"一等\";s:8:\"discount\";d:6.5;s:4:\"rate\";s:2:\"5%\";}i:1;a:3:{s:4:\"name\";s:6:\"二等\";s:8:\"discount\";i:7;s:4:\"rate\";s:2:\"3%\";}i:2;a:3:{s:4:\"name\";s:6:\"三等\";s:8:\"discount\";d:7.5;s:4:\"rate\";s:4:\"1.5%\";}i:3;a:3:{s:4:\"name\";s:6:\"四等\";s:8:\"discount\";i:8;s:4:\"rate\";s:4:\"0.5%\";}}', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('983', '6', 'recommend_supply', 'hidden', '', '', 'a:5:{i:0;a:3:{s:4:\"name\";s:6:\"一等\";s:8:\"discount\";i:3;s:4:\"rate\";s:2:\"5%\";}i:1;a:3:{s:4:\"name\";s:6:\"二等\";s:8:\"discount\";d:3.5;s:4:\"rate\";s:2:\"4%\";}i:2;a:3:{s:4:\"name\";s:6:\"三等\";s:8:\"discount\";i:4;s:4:\"rate\";s:2:\"3%\";}i:3;a:3:{s:4:\"name\";s:6:\"四等\";s:8:\"discount\";d:4.5;s:4:\"rate\";s:2:\"2%\";}i:4;a:3:{s:4:\"name\";s:6:\"五等\";s:8:\"discount\";i:5;s:4:\"rate\";s:2:\"1%\";}}', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('984', '6', 'distribution_share_conf', 'hidden', '', '', 'a:2:{s:2:\"on\";i:1;s:5:\"rules\";a:9:{s:3:\"obj\";a:2:{i:0;i:0;i:1;i:1;}s:2:\"up\";a:3:{i:0;a:1:{s:4:\"rate\";s:2:\"5%\";}i:1;a:1:{s:4:\"rate\";s:2:\"6%\";}i:2;a:1:{s:4:\"rate\";s:2:\"7%\";}}s:4:\"self\";a:0:{}s:3:\"low\";a:0:{}s:5:\"agent\";a:3:{s:8:\"province\";a:1:{s:4:\"rate\";s:4:\"0.5%\";}s:4:\"city\";a:1:{s:4:\"rate\";s:4:\"0.5%\";}s:8:\"district\";a:1:{s:4:\"rate\";s:2:\"1%\";}}s:4:\"rate\";a:2:{s:5:\"money\";s:1:\"0\";s:9:\"e_voucher\";s:4:\"100%\";}s:13:\"grant_percent\";s:3:\"90%\";s:14:\"grant_duration\";i:36;s:10:\"grant_date\";s:2:\"10\";}}', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('985', '2', 'merchants_prefix', 'text', '', '', 'ecmoban_', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('986', '7', 'show_rank_price', 'select', '1,0', '', '0', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('987', '942', 'login_limited_num', 'hidden', '', '', '3', '30');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('988', '942', 'nav_cat_model', 'select', '0,1', '', '0', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('989', '942', 'index_article_cat', 'text', '', '', '', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('990', '8', 'user_account_code', 'select', '1,0', '', '1', '17');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('991', '3', 'marticle_index', 'text', '', '', '1,2,3,4', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('992', '2', 'no_brand', 'file', '', '../images/', '', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('993', '942', 'open_study', 'select', '0,1', '', '0', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('994', '0', 'hometheme', 'hidden', '', '', '', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('995', '942', 'openvisual', 'select', '0,1', '', '0', '1');
