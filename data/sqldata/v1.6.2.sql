...
-- http://localhost
-- 
-- DATE : 2016-08-16 18:33:16
-- MYSQL SERVER VERSION : 5.5.40
-- PHP VERSION : 5.3.29
-- ECShop VERSION : v1.6.2
-- Vol : 1
...
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('605', '6', 'install_date', 'hidden', '', '', '1471343505', '1');
INSERT INTO `dsc_shop_config` ( `id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order` ) VALUES  ('606', '6', 'dsc_version', 'hidden', '', '', 'v1.6.1', '1');
