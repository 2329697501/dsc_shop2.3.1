...
$_LANG['label_transform_points'] = '抵用券兑换';
...
$_LANG['rank_integral'] = '等级抵用券';
$_LANG['consume_integral'] = '消费抵用券';
...
$_LANG['log_mobile_verify_error'] = '手机验证码输入错误';
...
$_LANG['return_integral_on_cancel'] = '取消订单 %s，退回支付订单时使用的抵用券';
...
$_LANG['your_order'] = '订单';
$_LANG['your_integral'] = '抵用券';
$_LANG['your_level'] = '您的等级是 %s ';
$_LANG['next_level'] = ',您还差 %s 抵用券达到 %s ';
$_LANG['attention'] = '关注';
...
$_LANG['password_shorter'] = '- 登录密码不能少于 6 个字符。';
$_LANG['confirm_password_invalid'] = ' 两次输入密码不一致';
...
　　２、访问者点击链接，访问网店。
　　３、在访问者点击链接的 <b>%d%s</b> 内，若该访问者在本站注册，即认定该用户是您推荐的，您将获得等级抵用券 <b>%d</b> 的奖励 (当您的等级抵用券超过 <b>%d</b> 时，不再获得奖励)。
　　４、该用户今后在本站的一切消费，您均能获得一定比例的提成。目前实行的提成总额为订单金额的 <b>%s</b> 、抵用券的 <b>%s</b> ，分配给您、推荐您的人等，具体分配规则请参阅 <b><a href="#myrecommend">我推荐的会员</a></b>。
...
　　４、您将获得该订单金额的 <b>%s</b> 、抵用券的 <b>%s</b>的奖励。
　　５、提成由管理员人工审核发放，请您耐心等待。
　　６、您可以通过分成明细来查看您的介绍、分成情况。';

$_LANG['level_point_all'] = '抵用券分成总额百分比';
$_LANG['level_money_all'] = '现金分成总额百分比';
$_LANG['level_register_all'] = '注册抵用券分成数';
$_LANG['level_register_up'] = '等级抵用券分成上限';
...
$_LANG['level_point'] = '抵用券分成百分比';
$_LANG['level_money'] = '现金分成百分比';

$_LANG['affiliate_status'] = '分成状态';

$_LANG['affiliate_point'] = '抵用券分成';
...
$_LANG['register_affiliate'] = '推荐会员ID %s ( %s ) 注册送抵用券';
$_LANG['register_points'] = '注册送抵用券';
...
/* 抵用券兑换 */
$_LANG['transform_points'] = '抵用券兑换';
$_LANG['invalid_points'] = '你输入的抵用券是不一个合法值';
$_LANG['invalid_input'] = '无效';
$_LANG['overflow_points'] = '您输入的兑换抵用券超过您的实际抵用券';
$_LANG['to_pay_points'] = '恭喜您， 你%s论坛%s兑换了%s的商城消费抵用券';
$_LANG['to_rank_points'] = '恭喜您， 你%s论坛%s兑换了%s的商城等级抵用券';
$_LANG['from_pay_points'] = '恭喜您， 你%s的商城消费抵用券兑换%s论坛%s';
$_LANG['from_rank_points'] = '恭喜您， 你%s论坛%s兑换了%s的商城消费抵用券';
$_LANG['cur_points'] = '您的当前抵用券';
...
$_LANG['exchange_points'][0] = '商城等级抵用券';
$_LANG['exchange_points'][1] = '商城消费抵用券';
$_LANG['exchange_action'] = '换';
$_LANG['exchange_js']['deny'] = '禁止兑换';
$_LANG['exchange_js']['balance'] = '您的{%s}余额不足，请重新输入';
$_LANG['exchange_deny'] = '该抵用券不允许兑换';
$_LANG['exchange_success'] = '恭喜您， 你用%s个%s兑换了%s个%s';
$_LANG['exchange_error_1'] = 'UCenter提交抵用券兑换时发生错误';
$_LANG['rank_points'] = '商城等级抵用券';
$_LANG['pay_points'] = '商城消费抵用券';
...
$_LANG['user_reg_info'][6] = '享受会员抵用券制度';
