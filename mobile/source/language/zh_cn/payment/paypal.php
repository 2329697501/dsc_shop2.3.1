...
$_LANG['paypal'] = 'paypal';
$_LANG['paypal_desc'] = 'PayPal（www.paypal.com） 是在线付款解决方案的全球领导者，在全世界有超过七千一百六十万个帐户用户。' . 'PayPal 可在 56 个市场以 7 种货币（加元、欧元、英镑、美元、日元、澳元、港元）使用。' . '<br/><a href="http://www.paypal.com" target="_blank">立即在线申请</a>';
