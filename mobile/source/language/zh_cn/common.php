...
$_LANG['exchange_sort']['exchange_integral'] = '按抵用券排序';
...
$_LANG['lack_pay_points'] = '你抵用券不够，不能出价';
$_LANG['snatch'] = '夺宝奇兵';
...
$_LANG['use_integral'] = '使用抵用券';
$_LANG['can_use_integral'] = '您当前的可用抵用券为';
...
$_LANG['order_gift_integral'] = '订单 %s 赠送的抵用券';
...
/* 抵用券兑换部分语言项 */
$_LANG['exchange'] = '抵用券商城';
$_LANG['exchange_integral'] = '消耗抵用券：';
$_LANG['exchange_goods'] = '立刻兑换';
$_LANG['eg_error_login'] = '对不起，您没有登录，不能参加兑换，请您先登录！';
$_LANG['eg_error_status'] = '对不起，该商品已经取消，现在不能兑换！';
$_LANG['eg_error_integral'] = '对不起，您现有的抵用券值不够兑换本商品！';
$_LANG['notice_eg_integral'] = '抵用券商城商品需要消耗抵用券：';
