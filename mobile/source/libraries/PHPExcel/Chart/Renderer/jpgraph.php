...
{
	static private $_width = 640;
	static private $_height = 480;
	static private $_colourSet = array('mediumpurple1', 'palegreen3', 'gold1', 'cadetblue1', 'darkmagenta', 'coral', 'dodgerblue3', 'eggplant', 'mediumblue', 'magenta', 'sandybrown', 'cyan', 'firebrick1', 'forestgreen', 'deeppink4', 'darkolivegreen', 'goldenrod2');
	static private $_markSet = array('diamond' => MARK_DIAMOND, 'square' => MARK_SQUARE, 'triangle' => MARK_UTRIANGLE, 'x' => MARK_X, 'star' => MARK_STAR, 'dot' => MARK_FILLEDCIRCLE, 'dash' => MARK_DTRIANGLE, 'circle' => MARK_CIRCLE, 'plus' => MARK_CROSS);
	private $_chart;
	private $_graph;
	static private $_plotColour = 0;
	static private $_plotMark = 0;
	...
	private function _formatDataSetLabels($groupID, $datasetLabels, $labelCount, $rotation = '')
	{
		...
		foreach ($datasetLabels as $i => $datasetLabel) {
			...
			else if (!is_null($datasetLabelFormatCode)) {
