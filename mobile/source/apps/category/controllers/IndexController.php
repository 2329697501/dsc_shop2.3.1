...
namespace apps\category\controllers;
...
class IndexController extends \apps\base\controllers\FrontendController
{
	...
	private function init_params()
	{
		...
		foreach ($brands as $key => $val) {
			...
			$brands[$temp_key]['url'] = u('products', array('id' => $this->cat_id, 'bid' => $val['brand_id'], 'price_min' => $this->price_min, 'price_max' => $this->price_max, 'filter_attr' => $this->filter_attr));
		...
		$brands[0]['url'] = u('products', array('cid' => $this->cat_id, 'bid' => 0, 'price_min' => $this->price_min, 'price_max' => $this->price_max, 'filter_attr' => $this->filter_attr));
		...
		if (0 < $this->cat['filter_attr']) {
			...
			foreach ($this->cat_filter_attr as $key => $value) {
				...
				if ($attributeInfo) {
					...
					$all_attr_list[$key]['attr_list'][0]['url'] = u('products', array('id' => $this->cat_id, 'bid' => $this->brand, 'price_min' => $this->price_min, 'price_max' => $this->price_max, 'filter_attr' => $temp_arrt_url));
					...
					foreach ($attr_list as $k => $v) {
						...
						$all_attr_list[$key]['attr_list'][$temp_key]['url'] = u('products', array('id' => $this->cat_id, 'bid' => $this->brand, 'price_min' => $this->price_min, 'price_max' => $this->price_max, 'filter_attr' => $temp_arrt_url));
