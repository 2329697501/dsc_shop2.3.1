...
class IndexController extends \apps\base\controllers\FrontendController
{
	...
	public function actionIndex()
	{
		...
		$this->assign('currency_format', sub_str($GLOBALS['_CFG']['currency_format'], 1, false));
	...
	public function actionAddToCart()
	{
		...
		if (!is_numeric($goods_number) || ($goods_number <= 0)) {
			...
			if (addto_cart($goods->goods_id, $goods_number, $goods->spec, $goods->parent, $warehouse_id, $area_id)) {
