...
namespace apps\goods\controllers;
...
class IndexController extends \apps\base\controllers\FrontendController
{
	...
	{
		parent::__construct();
		l(require ROOT_PATH . 'source/language/' . c('shop.lang') . '/goods.php');
	...
	public function actionIndex()
	{
		...
		if (file_exists(ROOT_PATH . 'data/caches/app/drp/installed.lock')) {
		...
		$this->assign('goods_store_cat', $goods_store_cat);
