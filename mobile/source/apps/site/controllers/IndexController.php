...
class IndexController extends \apps\base\controllers\FrontendController
{
	...
	public function actionIndex()
	{
		...
		$this->assign('best_goods', goods_list('best', $this->page, $this->size, $this->region_id, $this->area_info['region_id']));
	...
	public function actionAsyncList()
	{
		if (IS_AJAX) {
			...
			exit(json_encode(array('list' => $get_goods_list, 'totalPage' => $count)));
		}
	}
	...
	public function actionMigrate()
	{
		...
		show_message(l('data_migrate'), l('back_home_page'), u('site/index/index'), 'success');
	}
}
