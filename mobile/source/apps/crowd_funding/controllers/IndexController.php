...
namespace apps\crowd_funding\controllers;
...
class IndexController extends \apps\base\controllers\FrontendController
{
	...
	public function actiondone()
	{
		...
		$sql = ' SELECT COUNT(order_id) FROM ' . $this->ecs->table('order_info') . ' WHERE user_id = \'' . $_SESSION['user_id'] . '\' AND is_zc_order = 1 AND zc_goods_id = \'' . $_SESSION['id'] . '\' AND pay_status = 0 ';
		...
		$shipping = zc_get_order_post_shipping($shipping_arr);
