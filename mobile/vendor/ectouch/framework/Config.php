...
class Config
{
	...
	static public function init($basePath = '')
	{
		self::$config = array(
			...
			'TPL'                => array('TPL_PATH' => $basePath, 'TPL_SUFFIX' => '.html', 'TPL_CACHE' => 'TPL_CACHE', 'TPL_DEPR' => '_', 'TPL_TEMPLATE' => 'default'),
			'CACHE'              => array(
				'TPL_CACHE' => array('CACHE_TYPE' => 'FileCache', 'CACHE_PATH' => $basePath . 'data/caches/', 'GROUP' => 'tpl', 'HASH_DEEP' => 0),
				'DB_CACHE'  => array('CACHE_TYPE' => 'FileCache', 'CACHE_PATH' => $basePath . 'data/caches/', 'GROUP' => 'db', 'HASH_DEEP' => 2)
				),
			'STORAGE'            => array(
