...
class RefoundController extends \http\base\controllers\FrontendController
{
	private $user_id;
	...
	public function actionSubmitReturn()
	{
		...
		$return_number = (empty($_REQUEST['goods_number']) ? 1 : intval($_REQUEST['return_num']));
