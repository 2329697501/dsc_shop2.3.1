...
class AdminController extends \http\base\controllers\BackendController
{
	...
	{
		$condition['type'] = $type;
		$info = $this->model->table('touch_auth')->field('auth_config, status, sort')->where($condition)->find();
